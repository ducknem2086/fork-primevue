...
describe('Textarea.vue', () => {
    ...
    it('should input', async () => {
        await wrapper.vm.onInput({ target: { value: '@app/oda-component' } });

        expect(wrapper.emitted()['update:modelValue'][0]).toEqual(['@app/oda-component']);
    });
    ...
    it('should resize', async () => {
        ...
        await wrapper.vm.onInput({ target: { value: 'OdaComponents\nOdaComponents\nOdaComponents' } });
