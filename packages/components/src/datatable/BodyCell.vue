...
<script>
import { getAttribute, getFirstFocusableElement, getNextElementSibling, getOuterWidth, getPreviousElementSibling, invokeElementMethod } from '@oda-components/utils/dom';
import { resolveFieldData } from '@oda-components/utils/object';
import BaseComponent from '@oda-components/core/basecomponent';
import { getVNodeProp } from '@oda-components/core/utils';
import BarsIcon from '@oda-components/icons/bars';
...
import PencilIcon from '@oda-components/icons/pencil';
...
export default {
    ...
    computed: {
        ...
        expandButtonAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? (this.isRowExpanded ? this.$OdaComponents.config.locale.aria.expandRow : this.$OdaComponents.config.locale.aria.collapseRow) : undefined;
        },
        initButtonAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.editRow : undefined;
        },
        saveButtonAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.saveEdit : undefined;
        },
        cancelButtonAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.cancelEdit : undefined;
        }
    },
    components: {
