...
import { setAttribute } from '@app/oda-component/utils/dom';
...
import ToastEventBus from '@app/oda-component/toasteventbus';
...
export default {
    ...
    methods: {
        ...
        onEnter() {
            if (this.autoZIndex) {
                ZIndex.set('modal', this.$refs.container, this.baseZIndex || this.$OdaComponents.config.zIndex.modal);
            }
        },
        onLeave() {
