...
<script>
import { find, scrollInView, setAttribute } from '@app/oda-component/utils/dom';
import { findIndexInList, isEmpty } from '@app/oda-component/utils/object';
import AngleDoubleDownIcon from '@app/oda-component/icons/angledoubledown';
import AngleDoubleLeftIcon from '@app/oda-component/icons/angledoubleleft';
import AngleDoubleRightIcon from '@app/oda-component/icons/angledoubleright';
import AngleDoubleUpIcon from '@app/oda-component/icons/angledoubleup';
import AngleDownIcon from '@app/oda-component/icons/angledown';
import AngleLeftIcon from '@app/oda-component/icons/angleleft';
import AngleRightIcon from '@app/oda-component/icons/angleright';
import AngleUpIcon from '@app/oda-component/icons/angleup';
import Button from '@app/oda-component/button';
import Listbox from '@app/oda-component/listbox';
    ...
    methods: {
        ...
        createStyle() {
            if (!this.styleElement && !this.isUnstyled) {
                ...
                setAttribute(this.styleElement, 'nonce', this.$OdaComponents?.config?.csp?.nonce);
...
`;
    ...
    computed: {
        ...
        moveUpAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.moveUp : undefined;
        },
        moveTopAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.moveTop : undefined;
        },
        moveDownAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.moveDown : undefined;
        },
        moveBottomAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.moveBottom : undefined;
        },
        moveToTargetAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.moveToTarget : undefined;
        },
        moveAllToTargetAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.moveAllToTarget : undefined;
        },
        moveToSourceAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.moveToSource : undefined;
        },
        moveAllToSourceAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.moveAllToSource : undefined;
        }
    },
    components: {
        Listbox,
