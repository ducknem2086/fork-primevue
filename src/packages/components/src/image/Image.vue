...
<script>
import { addClass, focus, isAttributeEquals } from '@app/oda-component/utils/dom';
import { ZIndex } from '@app/oda-component/utils/zindex';
import EyeIcon from '@app/oda-component/icons/eye';
import RefreshIcon from '@app/oda-component/icons/refresh';
import SearchMinusIcon from '@app/oda-component/icons/searchminus';
import SearchPlusIcon from '@app/oda-component/icons/searchplus';
import TimesIcon from '@app/oda-component/icons/times';
import UndoIcon from '@app/oda-component/icons/undo';
import FocusTrap from '@app/oda-component/focustrap';
import Portal from '@app/oda-component/portal';
import { blockBodyScroll, unblockBodyScroll } from '@app/oda-component/utils';
...
export default {
    ...
    methods: {
        ...
        onBeforeEnter() {
            ZIndex.set('modal', this.mask, this.$OdaComponents.config.zIndex.modal);
        },
        onEnter() {
            this.focus();
            this.$emit('show');
    ...
    computed: {
        ...
        rightAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.rotateRight : undefined;
        },
        leftAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.rotateLeft : undefined;
        },
        zoomInAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.zoomIn : undefined;
        },
        zoomOutAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.zoomOut : undefined;
        },
        zoomImageAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.zoomImage : undefined;
        },
        closeAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.close : undefined;
        }
    },
    components: {
        Portal: Portal,
