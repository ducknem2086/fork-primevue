...
import { absolutePosition, addStyle, getOuterWidth, isTouchDevice, relativePosition } from '@app/oda-component/utils/dom';
...
import EyeSlashIcon from '@app/oda-component/icons/eyeslash';
...
export default {
    ...
    computed: {
        ...
        weakText() {
            return this.weakLabel || this.$OdaComponents.config.locale.weak;
        },
        mediumText() {
            return this.mediumLabel || this.$OdaComponents.config.locale.medium;
        },
        strongText() {
            return this.strongLabel || this.$OdaComponents.config.locale.strong;
        },
        promptText() {
            return this.promptLabel || this.$OdaComponents.config.locale.passwordPrompt;
        },
        isClearIconVisible() {
