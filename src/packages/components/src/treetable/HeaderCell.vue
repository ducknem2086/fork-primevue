...
<script>
import { getAttribute, getIndex, getNextElementSibling, getOuterWidth, getPreviousElementSibling } from '@app/oda-component/utils/dom';
import BaseComponent from '@app/oda-component/core/basecomponent';
import { getVNodeProp } from '@app/oda-component/core/utils';
import SortAltIcon from '@app/oda-component/icons/sortalt';
import SortAmountDownIcon from '@app/oda-component/icons/sortamountdown';
import SortAmountUpAltIcon from '@app/oda-component/icons/sortamountupalt';
import Badge from '@app/oda-component/badge';
