 ...
 *
 * [Live Demo](https://www.OdaComponents.org/multiselect/)
 *
 * @module multiselect
 *
 */
import type { DefineComponent, DesignToken, EmitFn, HintedString, PassThrough } from '@oda-components/core';
import type { ComponentHooks } from '@oda-components/core/basecomponent';
...
import type { VirtualScrollerItemOptions, VirtualScrollerPassThroughOptionType, VirtualScrollerProps } from 'oda-components/virtualscroller';
...
export interface MultiSelectProps {
    ...
    /**
     * Text to be displayed in hidden accessible field when filtering returns any results. Defaults to value from OdaComponents locale configuration.
     * @defaultValue '{0} results are available'
     */
    filterMessage?: string | undefined;
    /**
     * Text to be displayed in hidden accessible field when options are selected. Defaults to value from OdaComponents locale configuration.
     * @defaultValue null
     */
    selectionMessage?: string | undefined;
    /**
     * Text to be displayed in hidden accessible field when any option is not selected. Defaults to value from OdaComponents locale configuration.
     * @defaultValue No selected item
     */
    emptySelectionMessage?: string | undefined;
    /**
     * Text to display when filtering does not return any results. Defaults to value from OdaComponents locale configuration.
     * @defaultValue No results found
     */
    emptyFilterMessage?: string | undefined;
    /**
     * Text to display when there are no options available. Defaults to value from OdaComponents locale configuration.
