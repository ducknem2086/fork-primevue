 ...
 *
 */
import type { StyleOptions, ThemeOptions } from '@oda-components/styled';
...
// @todo: Remove this when the types are fixed in the styled package. Use `ColorScale` from `@oda-components/styled` instead.
