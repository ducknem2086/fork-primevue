...
<script>
import { find, scrollInView, setAttribute } from '@oda-components/utils/dom';
import { findIndexInList, isEmpty } from '@oda-components/utils/object';
import AngleDoubleDownIcon from '@oda-components/icons/angledoubledown';
import AngleDoubleLeftIcon from '@oda-components/icons/angledoubleleft';
import AngleDoubleRightIcon from '@oda-components/icons/angledoubleright';
import AngleDoubleUpIcon from '@oda-components/icons/angledoubleup';
import AngleDownIcon from '@oda-components/icons/angledown';
import AngleLeftIcon from '@oda-components/icons/angleleft';
import AngleRightIcon from '@oda-components/icons/angleright';
import AngleUpIcon from '@oda-components/icons/angleup';
import Button from 'oda-components/button';
import Listbox from 'oda-components/listbox';
