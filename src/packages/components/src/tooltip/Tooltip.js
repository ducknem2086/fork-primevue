import { addClass, createElement, fadeIn, findSingle, getAttribute, getOuterHeight, getOuterWidth, getViewport, getWindowScrollLeft, getWindowScrollTop, hasClass, isExist, isTouchDevice, removeClass } from '@app/oda-component/utils/dom';
import { isEmpty } from '@app/oda-component/utils/object';
...
const Tooltip = BaseTooltip.extend('tooltip', {
    beforeMount(el, options) {
        ...
        target.$_ptooltipZIndex = options.instance.$OdaComponents?.config?.zIndex?.tooltip;
