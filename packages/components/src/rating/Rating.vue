...
import { focus, getFirstFocusableElement } from '@oda-components/utils/dom';
import BanIcon from '@oda-components/icons/ban';
import StarIcon from '@oda-components/icons/star';
import StarFillIcon from '@oda-components/icons/starfill';
