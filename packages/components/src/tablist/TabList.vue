...
import { findSingle, getHeight, getOffset, getOuterHeight, getOuterWidth, getWidth, isRTL } from '@oda-components/utils/dom';
...
export default {
    ...
    computed: {
        ...
        prevButtonAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.previous : undefined;
        },
        nextButtonAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.next : undefined;
        },
        dataP() {
            return cn({
