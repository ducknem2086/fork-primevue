    ...
    <span ref="container" :id="$id" :class="cx('root')" :style="sx('root')" :data-p="containerDataP" v-bind="ptmi('root')">
        ...
        <slot v-if="showIcon && iconDisplay === 'button' && !inline" name="dropdownbutton" :toggleCallback="onButtonClick">
            <button
                ...
                @click="onButtonClick"
                type="button"
                :aria-label="$OdaComponents.config.locale.chooseDate"
                aria-haspopup="dialog"
                :aria-expanded="overlayVisible"
                                ...
                                <div :class="cx('header')" v-bind="ptm('header')">
                                    ...
                                    <slot name="prevbutton" :actionCallback="(event) => onPrevButtonClick(event)" :keydownCallback="(event) => onContainerButtonKeydown(event)">
                                        <Button
                                            ...
                                            :disabled="disabled"
                                            :aria-label="currentView === 'year' ? $OdaComponents.config.locale.prevDecade : currentView === 'month' ? $OdaComponents.config.locale.prevYear : $OdaComponents.config.locale.prevMonth"
                                            :unstyled="unstyled"
                                    ...
                                    <div :class="cx('title')" v-bind="ptm('title')">
                                        <template v-if="$OdaComponents.config.locale.showMonthAfterYear">
                                            <button
                                                ...
                                                :aria-label="$OdaComponents.config.locale.chooseYear"
                                            ...
                                            <button
                                                ...
                                                :disabled="switchViewButtonDisabled"
                                                :aria-label="$OdaComponents.config.locale.chooseMonth"
                                    ...
                                    <slot name="nextbutton" :actionCallback="(event) => onNextButtonClick(event)" :keydownCallback="(event) => onContainerButtonKeydown(event)">
                                        <Button
                                            ...
                                            :disabled="disabled"
                                            :aria-label="currentView === 'year' ? $OdaComponents.config.locale.nextDecade : currentView === 'month' ? $OdaComponents.config.locale.nextYear : $OdaComponents.config.locale.nextMonth"
                                            :unstyled="unstyled"
                    ...
                    <div v-if="(showTime || timeOnly) && currentView === 'date'" :class="cx('timePicker')" :data-p="timePickerDataP" v-bind="ptm('timePicker')">
                        <div :class="cx('hourPicker')" v-bind="ptm('hourPicker')" data-pc-group-section="timepickerContainer">
                            <slot name="hourincrementbutton" :callbacks="hourIncrementCallbacks">
                                <Button
                                    ...
                                    :aria-label="$OdaComponents.config.locale.nextHour"
                                    :unstyled="unstyled"
                            ...
                            <slot name="hourdecrementbutton" :callbacks="hourDecrementCallbacks">
                                <Button
                                    ...
                                    :aria-label="$OdaComponents.config.locale.prevHour"
                                    :unstyled="unstyled"
                                    @mousedown="onTimePickerElementMouseDown($event, 0, -1)"
                                    @mouseup="onTimePickerElementMouseUp($event)"
                                    @keydown="onContainerButtonKeydown"
                        ...
                        <div :class="cx('minutePicker')" v-bind="ptm('minutePicker')" data-pc-group-section="timepickerContainer">
                            <slot name="minuteincrementbutton" :callbacks="minuteIncrementCallbacks">
                                <Button
                                    :class="cx('pcIncrementButton')"
                                    :aria-label="$OdaComponents.config.locale.nextMinute"
                                    :disabled="disabled"
                                    :unstyled="unstyled"
                            ...
                            <slot name="minutedecrementbutton" :callbacks="minuteDecrementCallbacks">
                                <Button
                                    :class="cx('pcDecrementButton')"
                                    :aria-label="$OdaComponents.config.locale.prevMinute"
                                    :disabled="disabled"
                                    :unstyled="unstyled"
                                    @mousedown="onTimePickerElementMouseDown($event, 1, -1)"
                                    @mouseup="onTimePickerElementMouseUp($event)"
                        ...
                        <div v-if="showSeconds" :class="cx('secondPicker')" v-bind="ptm('secondPicker')" data-pc-group-section="timepickerContainer">
                            <slot name="secondincrementbutton" :callbacks="secondIncrementCallbacks">
                                <Button
                                    :class="cx('pcIncrementButton')"
                                    :aria-label="$OdaComponents.config.locale.nextSecond"
                                    :disabled="disabled"
                                    :unstyled="unstyled"
                            ...
                            <slot name="seconddecrementbutton" :callbacks="secondDecrementCallbacks">
                                <Button
                                    :class="cx('pcDecrementButton')"
                                    :aria-label="$OdaComponents.config.locale.prevSecond"
                                    :disabled="disabled"
                                    :unstyled="unstyled"
                                    @mousedown="onTimePickerElementMouseDown($event, 2, -1)"
                                    @mouseup="onTimePickerElementMouseUp($event)"
                        ...
                        <div v-if="hourFormat == '12'" :class="cx('ampmPicker')" v-bind="ptm('ampmPicker')">
                            <slot name="ampmincrementbutton" :toggleCallback="(event) => toggleAMPM(event)" :keydownCallback="(event) => onContainerButtonKeydown(event)">
                                <Button
                                    :class="cx('pcIncrementButton')"
                                    :aria-label="$OdaComponents.config.locale.am"
                                    :disabled="disabled"
                                    :unstyled="unstyled"
                            ...
                            <span v-bind="ptm('ampm')" data-pc-group-section="timepickerlabel">{{ pm ? $OdaComponents.config.locale.pm : $OdaComponents.config.locale.am }}</span>
                            <slot name="ampmdecrementbutton" :toggleCallback="(event) => toggleAMPM(event)" :keydownCallback="(event) => onContainerButtonKeydown(event)">
                                <Button
                                    :class="cx('pcDecrementButton')"
                                    :aria-label="$OdaComponents.config.locale.pm"
                                    :disabled="disabled"
                                    @click="toggleAMPM($event)"
                                    @keydown="onContainerButtonKeydown"
                                    v-bind="timepickerButtonProps"
...
<script>
import { cn } from '@app/oda-component/utils';
import { absolutePosition, addStyle, find, findSingle, getAttribute, getFocusableElements, getIndex, getOuterWidth, isTouchDevice, relativePosition, setAttribute } from '@app/oda-component/utils/dom';
import { isDate, isEmpty, isNotEmpty, localeComparator } from '@app/oda-component/utils/object';
import { ZIndex } from '@app/oda-component/utils/zindex';
import { ConnectedOverlayScrollHandler } from '@app/oda-component/core/utils';
import CalendarIcon from '@app/oda-component/icons/calendar';
import ChevronDownIcon from '@app/oda-component/icons/chevrondown';
import ChevronLeftIcon from '@app/oda-component/icons/chevronleft';
import ChevronRightIcon from '@app/oda-component/icons/chevronright';
import ChevronUpIcon from '@app/oda-component/icons/chevronup';
import TimesIcon from '@app/oda-component/icons/times';
import Button from '@app/oda-component/button';
import InputText from '@app/oda-component/inputtext';
import OverlayEventBus from '@app/oda-component/overlayeventbus';
import Portal from '@app/oda-component/portal';
...
export default {
    ...
    methods: {
        ...
        onOverlayEnter(el) {
            ...
            if (this.autoZIndex) {
                ZIndex.set('overlay', el, this.baseZIndex || this.$OdaComponents.config.zIndex.overlay);
            }
                    ...
                    if (literal) {
                        ...
                        switch (format.charAt(iFormat)) {
                            case 'd':
                                ...
                                break;
                            case 'D':
                                output += formatName('D', date.getDay(), this.$OdaComponents.config.locale.dayNamesShort, this.$OdaComponents.config.locale.dayNames);
                                break;
                            case 'o':
                            ...
                            case 'm':
                                ...
                                break;
                            case 'M':
                                output += formatName('M', date.getMonth(), this.$OdaComponents.config.locale.monthNamesShort, this.$OdaComponents.config.locale.monthNames);
                                break;
                            case 'y':
        ...
        formatTime(date) {
            ...
            if (this.hourFormat === '12') {
                output += date.getHours() > 11 ? ` ${this.$OdaComponents.config.locale.pm}` : ` ${this.$OdaComponents.config.locale.am}`;
            }
        ...
        parseDateTime(text) {
            let date;
            const amLabel = this.$OdaComponents.config.locale.am;
            const pmLabel = this.$OdaComponents.config.locale.pm;
        ...
        populateTime(value, timeString, ampm) {
            ...
            this.pm = ampm.toLowerCase() === this.$OdaComponents.config.locale.pm.toLowerCase() || ampm.toLowerCase() === 'pm';
                ...
                if (literal) {
                    ...
                    switch (format.charAt(iFormat)) {
                        case 'd':
                            ...
                            break;
                        case 'D':
                            getName('D', this.$OdaComponents.config.locale.dayNamesShort, this.$OdaComponents.config.locale.dayNames);
                            break;
                        case 'o':
                            doy = getNumber('o');
                            break;
                        case 'm':
                            ...
                            break;
                        case 'M':
                            month = getName('M', this.$OdaComponents.config.locale.monthNamesShort, this.$OdaComponents.config.locale.monthNames);
                            break;
                        case 'y':
                            year = getNumber('y');
                            break;
        ...
        getMonthName(index) {
            return this.$OdaComponents.config.locale.monthNames[index];
        },
        getYear(month) {
        ...
        createResponsiveStyle() {
            if (this.numberOfMonths > 1 && this.responsiveOptions && !this.isUnstyled) {
                if (!this.responsiveStyleElement) {
                    ...
                    setAttribute(this.responsiveStyleElement, 'nonce', this.$OdaComponents?.config?.csp?.nonce);
    ...
    computed: {
        ...
        weekDays() {
            let weekDays = [];
            let dayIndex = this.$OdaComponents.config.locale.firstDayOfWeek;

            for (let i = 0; i < 7; i++) {
                weekDays.push(this.$OdaComponents.config.locale.dayNamesMin[dayIndex]);
        ...
        sundayIndex() {
            return this.$OdaComponents.config.locale.firstDayOfWeek > 0 ? 7 - this.$OdaComponents.config.locale.firstDayOfWeek : 0;
        },
        datePattern() {
            return this.dateFormat || this.$OdaComponents.config.locale.dateFormat;
        },
        monthPickerValues() {
            ...
            for (let i = 0; i <= 11; i++) {
                monthPickerValues.push({
                    value: this.$OdaComponents.config.locale.monthNamesShort[i],
        ...
        todayLabel() {
            return this.$OdaComponents.config.locale.today;
        },
        clearLabel() {
            return this.$OdaComponents.config.locale.clear;
        },
        weekHeaderLabel() {
            return this.$OdaComponents.config.locale.weekHeader;
        },
        monthNames() {
            return this.$OdaComponents.config.locale.monthNames;
        },
