...
<script>
import { addClass, focus, isAttributeEquals } from '@oda-components/utils/dom';
import { ZIndex } from '@oda-components/utils/zindex';
import EyeIcon from '@oda-components/icons/eye';
import RefreshIcon from '@oda-components/icons/refresh';
import SearchMinusIcon from '@oda-components/icons/searchminus';
import SearchPlusIcon from '@oda-components/icons/searchplus';
import TimesIcon from '@oda-components/icons/times';
import UndoIcon from '@oda-components/icons/undo';
import FocusTrap from 'oda-components/focustrap';
import Portal from 'oda-components/portal';
import { blockBodyScroll, unblockBodyScroll } from 'oda-components/utils';
