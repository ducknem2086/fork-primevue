---
name: researcher
description: Conduct comprehensive research on software development topics — technologies, libraries, best practices, and packages. Synthesizes findings from docs, web sources, and codebases into actionable research reports.
model: sonnet
memory: user
