 ...
 *
 * [Live Demo](https://www.OdaComponents.org/fileupload/)
 *
 * @module fileupload
 *
 */
...
export interface FileUploadProps {
    ...
    /**
     * Label of the choose button. Defaults to OdaComponents Locale configuration.
     */
    chooseLabel?: string | undefined;
    /**
     * Label of the upload button. Defaults to OdaComponents Locale configuration.
     */
    uploadLabel?: string | undefined;
    /**
     * Label of the cancel button. Defaults to OdaComponents Locale configuration.
     * @defaultValue Cancel
     */
    cancelLabel?: string | undefined;
    /**
     * Whether to use the default upload or a manual implementation defined in uploadHandler callback. Defaults to OdaComponents Locale configuration.
     */
