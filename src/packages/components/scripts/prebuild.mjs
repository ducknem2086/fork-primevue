...
// Utils
export * from '@app/oda-component/utils';

// UseConfirm
export * from '@app/oda-component/useconfirm';

// UseDialog
export * from '@app/oda-component/usedialog';

// UseToast
export * from '@app/oda-component/usetoast';

// UseStyle
export * from '@app/oda-component/usestyle';
`
    ]
};
...
`
                    ...
                    modules.esm.push(
                        `
// ${fileName}
export * from '@app/oda-component/${folderName}';
export { default as ${fileName} } from '@app/oda-component/${folderName}';
`
                    );
                }
...
`
                                ...
                                modules.esm.push(
                                    `export * from '@app/oda-component/${folderName}/style';
export { default as ${subFileName} } from '@app/oda-component/${folderName}/style';
`
                                );
                            }
                        }
