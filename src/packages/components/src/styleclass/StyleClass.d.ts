 ...
 *
 * [Live Demo](https://OdaComponents.org/styleclass)
 *
 * @module styleclass
 *
 */
import type { DesignToken, HintedString, PassThrough } from '@app/oda-component/core';
import type { DirectiveHooks } from '@app/oda-component/core/basedirective';
