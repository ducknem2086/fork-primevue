...
<script>
import { absolutePosition, addStyle, findSingle, focus, getOuterWidth, isTouchDevice } from '@app/oda-component/utils/dom';
import { findLastIndex, isEmpty, isNotEmpty, isPrintableCharacter, resolve } from '@app/oda-component/utils/object';
...
export default {
    ...
    methods: {
        ...
        onEnter(el) {
            if (this.autoZIndex) {
                ZIndex.set('menu', el, this.baseZIndex || this.$OdaComponents.config.zIndex.menu);
            }
