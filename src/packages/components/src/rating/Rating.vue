...
import { focus, getFirstFocusableElement } from '@app/oda-component/utils/dom';
import BanIcon from '@app/oda-component/icons/ban';
import StarIcon from '@app/oda-component/icons/star';
import StarFillIcon from '@app/oda-component/icons/starfill';
...
export default {
    ...
    methods: {
        ...
        starAriaLabel(value) {
            return value === 1 ? this.$OdaComponents.config.locale.aria.star : this.$OdaComponents.config.locale.aria.stars.replace(/{star}/g, value);
        },
        dataOption(value) {
            return cn({
