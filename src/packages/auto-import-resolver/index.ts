import { components, directives, MetaType } from '@oda-components/metadata';
import type { ComponentResolver, ComponentResolveResult } from 'unplugin-vue-components/types';

export interface OdaComponentsResolverOptions {
    components?: {
        prefix?: string;
    };
    directives?: {
...
export function OdaComponentsResolver(options: OdaComponentsResolverOptions = {}): ComponentResolver[] {
