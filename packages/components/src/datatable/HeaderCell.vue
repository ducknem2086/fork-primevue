...
<script>
import { getAttribute, getIndex, getNextElementSibling, getOuterWidth, getPreviousElementSibling } from '@oda-components/utils/dom';
import BaseComponent from '@oda-components/core/basecomponent';
import { getVNodeProp } from '@oda-components/core/utils';
import SortAltIcon from '@oda-components/icons/sortalt';
import SortAmountDownIcon from '@oda-components/icons/sortamountdown';
import SortAmountUpAltIcon from '@oda-components/icons/sortamountupalt';
