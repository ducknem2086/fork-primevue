 ...
 *
 * [Live Demo](https://www.OdaComponents.org/cascadeselect/)
 *
...
export interface CascadeSelectProps {
    ...
    /**
     * Text to be displayed when there are no options available. Defaults to value from OdaComponents locale configuration.
