...
import { absolutePosition, addClass, focus, getOffset, isTouchDevice } from '@app/oda-component/utils/dom';
    ...
    computed: {
        ...
        acceptLabel() {
            if (this.confirmation) {
                ...
                return confirmation.acceptLabel || confirmation.acceptProps?.label || this.$OdaComponents.config.locale.accept;
            }

            return this.$OdaComponents.config.locale.accept;
        },
        rejectLabel() {
            if (this.confirmation) {
                const confirmation = this.confirmation;

                return confirmation.rejectLabel || confirmation.rejectProps?.label || this.$OdaComponents.config.locale.reject;
            }

            return this.$OdaComponents.config.locale.reject;
        },
        acceptIcon() {
