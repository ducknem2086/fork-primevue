...
import type { CheckboxPassThroughOptionType } from 'oda-components/checkbox';
...
import type { RadioButtonPassThroughOptionType } from 'oda-components/radiobutton';
import type { SelectPassThroughOptionType } from 'oda-components/select';
import type { VirtualScrollerLoaderOptions } from 'oda-components/virtualscroller';
...
export interface ColumnProps {
    ...
    /**
     * Type of data. It's value is related to OdaComponents.filterMatchModeOptions config.
     */
