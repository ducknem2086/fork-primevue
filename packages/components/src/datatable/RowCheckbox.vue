...
export default {
    ...
    computed: {
        checkboxAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? (this.checked ? this.$OdaComponents.config.locale.aria.selectRow : this.$OdaComponents.config.locale.aria.unselectRow) : undefined;
        }
    },
    components: {
        CheckIcon,
