...
<script>
import { absolutePosition, addStyle, focus, getAttribute, isTouchDevice } from '@app/oda-component/utils/dom';
import { ZIndex } from '@app/oda-component/utils/zindex';
import { FilterOperator } from '@app/oda-component/core/api';
...
import FilterIcon from '@app/oda-component/icons/filter';
import FilterFillIcon from '@app/oda-component/icons/filterfill';
import FilterSlashIcon from '@app/oda-component/icons/filterslash';
import PlusIcon from '@app/oda-component/icons/plus';
import TrashIcon from '@app/oda-component/icons/trash';
import Button from '@app/oda-component/button';
import FocusTrap from '@app/oda-component/focustrap';
import OverlayEventBus from '@app/oda-component/overlayeventbus';
import Portal from '@app/oda-component/portal';
import Select from '@app/oda-component/select';
    ...
    computed: {
        ...
        matchModes() {
            return (
                ...
                this.$OdaComponents.config.filterMatchModeOptions[this.type].map((key) => {
                    return { label: this.$OdaComponents.config.locale[key], value: key };
                })
            );
        },
        isShowMatchModes() {
        ...
        operatorOptions() {
            return [
                { label: this.$OdaComponents.config.locale.matchAll, value: FilterOperator.AND },
                { label: this.$OdaComponents.config.locale.matchAny, value: FilterOperator.OR }
            ];
        },
        noFilterLabel() {
            return this.$OdaComponents.config.locale ? this.$OdaComponents.config.locale.noFilter : undefined;
        },
        isShowOperator() {
        ...
        removeRuleButtonLabel() {
            return this.$OdaComponents.config.locale ? this.$OdaComponents.config.locale.removeRule : undefined;
        },
        addRuleButtonLabel() {
            return this.$OdaComponents.config.locale ? this.$OdaComponents.config.locale.addRule : undefined;
        },
        isShowAddConstraint() {
            return this.showAddButton && this.filters[this.field].operator && this.fieldConstraints && this.fieldConstraints.length < this.maxConstraints;
        },
        clearButtonLabel() {
            return this.$OdaComponents.config.locale ? this.$OdaComponents.config.locale.clear : undefined;
        },
        applyButtonLabel() {
            return this.$OdaComponents.config.locale ? this.$OdaComponents.config.locale.apply : undefined;
        },
        columnFilterButtonAriaLabel() {
            return this.$OdaComponents.config.locale?.aria ? (this.overlayVisible ? this.$OdaComponents.config.locale.aria.hideFilterMenu : this.$OdaComponents.config.locale.aria.showFilterMenu) : undefined;
        },
        filterOperatorAriaLabel() {
            return this.$OdaComponents.config.locale ? this.$OdaComponents.config.locale.filterOperator : undefined;
        },
        filterRuleAriaLabel() {
            return this.$OdaComponents.config.locale ? this.$OdaComponents.config.locale.filterConstraint : undefined;
        },
