...
import { addClass, addStyle, focus, getOuterHeight, getOuterWidth, getViewport, setAttribute } from '@oda-components/utils/dom';
import { ZIndex } from '@oda-components/utils/zindex';
import TimesIcon from '@oda-components/icons/times';
import WindowMaximizeIcon from '@oda-components/icons/windowmaximize';
import WindowMinimizeIcon from '@oda-components/icons/windowminimize';
