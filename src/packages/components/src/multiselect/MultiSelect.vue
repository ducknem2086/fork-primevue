...
import { absolutePosition, addStyle, findSingle, focus, getFirstFocusableElement, getFocusableElements, getLastFocusableElement, getOuterWidth, isTouchDevice, relativePosition } from '@app/oda-component/utils/dom';
import { equals, findLastIndex, isEmpty, isNotEmpty, isPrintableCharacter, resolveFieldData } from '@app/oda-component/utils/object';
import { ZIndex } from '@app/oda-component/utils/zindex';
import { FilterService } from '@app/oda-component/core/api';
...
import SearchIcon from '@app/oda-component/icons/search';
import SpinnerIcon from '@app/oda-component/icons/spinner';
import TimesIcon from '@app/oda-component/icons/times';
import Checkbox from '@app/oda-component/checkbox';
import Chip from '@app/oda-component/chip';
import IconField from '@app/oda-component/iconfield';
import InputIcon from '@app/oda-component/inputicon';
...
import VirtualScroller from '@app/oda-component/virtualscroller';
...
export default {
    ...
    methods: {
        ...
        onOverlayEnter(el) {
            ZIndex.set('overlay', el, this.$OdaComponents.config.zIndex.overlay);
        ...
        getSelectedItemsLabel() {
            let pattern = /{(.*?)}/;
            const selectedItemsLabel = this.selectedItemsLabel || this.$OdaComponents.config.locale.selectionMessage;
    ...
    computed: {
        ...
        filterMessageText() {
            return this.filterMessage || this.$OdaComponents.config.locale.searchMessage || '';
        },
        emptyFilterMessageText() {
            return this.emptyFilterMessage || this.$OdaComponents.config.locale.emptySearchMessage || this.$OdaComponents.config.locale.emptyFilterMessage || '';
        },
        emptyMessageText() {
            return this.emptyMessage || this.$OdaComponents.config.locale.emptyMessage || '';
        },
        selectionMessageText() {
            return this.selectionMessage || this.$OdaComponents.config.locale.selectionMessage || '';
        },
        emptySelectionMessageText() {
            return this.emptySelectionMessage || this.$OdaComponents.config.locale.emptySelectionMessage || '';
        },
        selectedMessageText() {
        ...
        toggleAllAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria[this.allSelected ? 'selectAll' : 'unselectAll'] : undefined;
        },
        listAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.listLabel : undefined;
        },
