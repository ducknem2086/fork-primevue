...
const INLINE_EXTERNALS = [/@oda-components\/core\/.*/, /@oda-components\/utils\/.*/];
const EXTERNALS = [...GLOBAL_EXTERNALS, ...INLINE_EXTERNALS];

// alias
const ALIAS_ENTRIES = [
    {
        find: /^@OdaComponents\/forms\/(.*)$/,
    ...
    { find: '@oda-components/forms/useform', replacement: path.resolve(__dirname, './src/useform/index.js') }
];
