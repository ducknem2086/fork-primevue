...
export default {
    ...
    computed: {
        headerCheckboxAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? (this.checked ? this.$OdaComponents.config.locale.aria.selectAll : this.$OdaComponents.config.locale.aria.unselectAll) : undefined;
        }
    },
    components: {
        CheckIcon,
