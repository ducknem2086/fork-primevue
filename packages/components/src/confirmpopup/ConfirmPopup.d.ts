 ...
 *
 * [Live Demo](https://www.OdaComponents.org/confirmpopup)
 *
 * @module confirmpopup
 *
 */
import type { DefineComponent, DesignToken, EmitFn, PassThrough } from '@oda-components/core';
import type { ComponentHooks } from '@oda-components/core/basecomponent';
import { ButtonPassThroughOptions } from 'oda-components/button';
import { ConfirmationOptions } from 'oda-components/confirmationoptions';
