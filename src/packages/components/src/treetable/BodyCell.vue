...
<script>
import { getNextElementSibling, getOuterWidth, getPreviousElementSibling } from '@app/oda-component/utils/dom';
...
import MinusIcon from '@app/oda-component/icons/minus';
