...
describe('Chip.vue', () => {
    ...
    beforeEach(() => {
        wrapper = mount(Chip, {
            props: {
                label: '@app/oda-component',
                icon: 'pi pi-OdaComponents',
                removable: true
            }
        });
    });
    ...
    it('should exists', () => {
        ...
        expect(wrapper.find('.p-chip-icon').classes()).toContain('pi-OdaComponents');
        expect(wrapper.find('.p-chip-label').text()).toBe('@app/oda-component');
