...
<script>
import { addClass, removeClass } from '@oda-components/utils/dom';
import PlusIcon from '@oda-components/icons/plus';
import TimesIcon from '@oda-components/icons/times';
import UploadIcon from '@oda-components/icons/upload';
import Button from 'oda-components/button';
import Message from 'oda-components/message';
import ProgressBar from 'oda-components/progressbar';
