 ...
 *
 * [Live Demo](https://www.OdaComponents.org/password/)
 *
 * @module password
 *
 */
...
export interface PasswordProps extends Omit<InputHTMLAttributes, 'size'> {
    ...
    /**
     * Text to prompt password entry. Defaults to OdaComponents Locale configuration.
     */
    ...
    /**
     * Text for a weak password. Defaults to OdaComponents Locale configuration.
     */
    weakLabel?: string | undefined;
    /**
     * Text for a medium password. Defaults to OdaComponents Locale configuration.
     */
    mediumLabel?: string | undefined;
    /**
     * Text for a strong password. Defaults to OdaComponents Locale configuration.
     */
