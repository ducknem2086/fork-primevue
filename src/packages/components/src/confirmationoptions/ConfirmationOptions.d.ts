/**
 *
 * [Live Demo](https://www.OdaComponents.org/confirmdialog/)
 *
 * @module confirmationoptions
 *
 */
import type { HintedString } from '@app/oda-component/core';
...
export interface ConfirmationOptions {
    ...
    onHide?: () => void;
    /**
     * Label of the accept button. Defaults to OdaComponents Locale configuration.
     */
    acceptLabel?: string | undefined;
    /**
     * Label of the reject button. Defaults to OdaComponents Locale configuration.
     */
