...
import { addClass, addStyle, focus, getOuterHeight, getOuterWidth, getViewport, setAttribute } from '@app/oda-component/utils/dom';
import { ZIndex } from '@app/oda-component/utils/zindex';
import TimesIcon from '@app/oda-component/icons/times';
import WindowMaximizeIcon from '@app/oda-component/icons/windowmaximize';
import WindowMinimizeIcon from '@app/oda-component/icons/windowminimize';
...
export default {
    ...
    methods: {
        ...
        onEnter() {
            ...
            if (this.autoZIndex) {
                ZIndex.set('modal', this.mask, this.baseZIndex || this.$OdaComponents.config.zIndex.modal);
            }
        },
        onAfterEnter() {
            this.focus();
