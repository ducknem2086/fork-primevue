import { css as Css, Theme, dt } from '@app/oda-component/styled';
import { style } from '@app/oda-component/style-tokens/base';
import { isNotEmpty, minifyCSS, resolve } from '@app/oda-component/utils/object';
import { useStyle } from '@app/oda-component/core/usestyle';
...
export default {
    ...
    getStyleSheet(extendedCSS = '', props = {}) {
        if (this.css) {
            ...
            return isNotEmpty(_style) ? `<style type="text/css" data-OdaComponents-style-id="${this.name}" ${_props}>${_style}</style>` : '';
        }
    ...
    getThemeStyleSheet(params, props = {}) {
        ...
        if (this.style) {
            ...
            isNotEmpty(_style) && css.push(`<style type="text/css" data-OdaComponents-style-id="${name}" ${_props}>${_style}</style>`);
        }
