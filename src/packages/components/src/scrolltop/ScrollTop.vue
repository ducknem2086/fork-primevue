...
<script>
import { getWindowScrollTop } from '@app/oda-component/utils/dom';
...
export default {
    ...
    computed: {
        scrollTopAriaLabel() {
            return this.$OdaComponents.config.locale.aria ? this.$OdaComponents.config.locale.aria.scrollTop : undefined;
        }
    },
    components: {
        ChevronUpIcon,
