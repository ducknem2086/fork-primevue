...
import { absolutePosition, addStyle, findSingle, focus, getOuterWidth, isTouchDevice, relativePosition } from '@app/oda-component/utils/dom';
import { equals, findLastIndex, isEmpty, isNotEmpty, resolveFieldData } from '@app/oda-component/utils/object';
...
export default {
    ...
    computed: {
        ...
        searchMessageText() {
            return this.searchMessage || this.$OdaComponents.config.locale.searchMessage || '';
        },
        emptySearchMessageText() {
            return this.emptySearchMessage || this.$OdaComponents.config.locale.emptySearchMessage || '';
        },
