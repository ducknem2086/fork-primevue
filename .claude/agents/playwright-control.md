...
description: Senior automation tester using Playwright MCP to execute browser-based tests. Use for E2E tests, UI verification, page interaction checks, and browser rendering validation.
model: haiku
color: blue
