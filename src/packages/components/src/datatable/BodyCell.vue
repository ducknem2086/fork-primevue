...
<script>
import { getAttribute, getFirstFocusableElement, getNextElementSibling, getOuterWidth, getPreviousElementSibling, invokeElementMethod } from '@app/oda-component/utils/dom';
import { resolveFieldData } from '@app/oda-component/utils/object';
import BaseComponent from '@app/oda-component/core/basecomponent';
import { getVNodeProp } from '@app/oda-component/core/utils';
import BarsIcon from '@app/oda-component/icons/bars';
...
import PencilIcon from '@app/oda-component/icons/pencil';
