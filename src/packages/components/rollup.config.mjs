...
const INLINE_EXTERNALS = [/@oda-components\/core\/.*/, /@oda-components\/icons\/.*/, '@oda-components/styled', /@oda-components\/utils\/.*/];
...
const ALIAS_ENTRIES = [
    ...
    // @todo - Remove
    { find: '@oda-components/core/api', replacement: path.resolve(__dirname, '../core/src/api/Api.js') },
    { find: '@oda-components/core/base/style', replacement: path.resolve(__dirname, '../core/src/base/style/BaseStyle.js') },
    { find: '@oda-components/core/base', replacement: path.resolve(__dirname, '../core/src/base/Base.js') },
    { find: '@oda-components/core/basecomponent/style', replacement: path.resolve(__dirname, '../core/src/basecomponent/style/BaseComponentStyle.js') },
    { find: '@oda-components/core/basecomponent', replacement: path.resolve(__dirname, '../core/src/basecomponent/BaseComponent.vue') },
    { find: '@oda-components/core/basedirective', replacement: path.resolve(__dirname, '../core/src/basedirective/BaseDirective.js') },
    { find: '@oda-components/core/baseeditableholder', replacement: path.resolve(__dirname, '../core/src/baseeditableholder/BaseEditableHolder.vue') },
    { find: '@oda-components/core/baseinput', replacement: path.resolve(__dirname, '../core/src/baseinput/BaseInput.vue') },
    { find: '@oda-components/core/config', replacement: path.resolve(__dirname, '../core/src/config/OdaComponents.js') },
    { find: '@oda-components/core/service', replacement: path.resolve(__dirname, '../core/src/service/OdaComponentsService.js') },
    { find: '@oda-components/core/useattrselector', replacement: path.resolve(__dirname, '../core/src/useattrselector/UseAttrSelector.js') },
    { find: '@oda-components/core/useid', replacement: path.resolve(__dirname, '../core/src/useid/UseId.js') },
    { find: '@oda-components/core/usestyle', replacement: path.resolve(__dirname, '../core/src/usestyle/UseStyle.js') },
    { find: '@oda-components/core/utils', replacement: path.resolve(__dirname, '../core/src/utils/Utils.js') },
    { find: '@oda-components/core', replacement: path.resolve(__dirname, '../core/src/index.js') },
    { find: '@oda-components/icons/baseicon/style', replacement: path.resolve(__dirname, '../icons/src/baseicon/style/BaseIconStyle.js') },
    { find: '@oda-components/icons/baseicon', replacement: path.resolve(__dirname, '../icons/src/baseicon/BaseIcon.vue') }
];
...
function addLibrary() {
    ...
    ENTRY.format.umd({ name: 'OdaComponents', input: process.env.INPUT_DIR + 'umd/OdaComponents.js', output: process.env.OUTPUT_DIR + 'umd/OdaComponents', minify: true });
}
