...
<script>
import { absolutePosition, addStyle, focus, getAttribute, isTouchDevice } from '@oda-components/utils/dom';
import { ZIndex } from '@oda-components/utils/zindex';
import { FilterOperator } from '@oda-components/core/api';
...
import FilterIcon from '@oda-components/icons/filter';
import FilterFillIcon from '@oda-components/icons/filterfill';
import FilterSlashIcon from '@oda-components/icons/filterslash';
import PlusIcon from '@oda-components/icons/plus';
import TrashIcon from '@oda-components/icons/trash';
import Button from 'oda-components/button';
import FocusTrap from 'oda-components/focustrap';
import OverlayEventBus from 'oda-components/overlayeventbus';
import Portal from 'oda-components/portal';
import Select from 'oda-components/select';
