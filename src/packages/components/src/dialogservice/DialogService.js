import DynamicDialogEventBus from '@app/oda-component/dynamicdialogeventbus';
import { OdaComponentsDialogSymbol } from '@app/oda-component/usedialog';
...
export default {
    install: (app) => {
        ...
        app.provide(OdaComponentsDialogSymbol, DialogService);
    }
};
