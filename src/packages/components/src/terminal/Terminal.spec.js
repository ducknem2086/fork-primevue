...
import TerminalService from '@app/oda-component/terminalservice';
...
describe('Terminal.vue', () => {
    it('should return valid command', async () => {
        const wrapper = mount({
            ...
            template: `<Terminal welcomeMessage="Welcome to OdaComponents" prompt="OdaComponents $" class="dark-demo-terminal" />`,
            mounted() {
